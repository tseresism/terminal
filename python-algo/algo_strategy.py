...
'''
right and left: scouts + interceptors
middle : walls
factories : back
'''
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        wall_locations = [[5,13],[6,12],[7,11],[8,10],[9,9],[10,8],[11,7],[12,6],[13,5],[14,5],[15,6],[16,7],[17,8],[18,9],[19,10],[20,11],[21,12],[22,13]]
        # use up all our structure points
        extra_wall_locations = [[1,12],[2,11],[3,10],[4,9],[5,8],[6,7],[7,6],[8,5],[9,4],[10,3],[11,2],[12,1],[15,1],[16,2],[17,3],[18,4],[19,5],[20,6],[21,7],[22,8],[23,9],[24,10],[25,11],[26,12]]
        # if game_state.can_spawn(WALL, wall_locations):
        game_state.attempt_spawn(WALL, wall_locations, len(wall_locations))
        game_state.attempt_spawn(WALL, extra_wall_locations, len(extra_wall_locations))

        factory_locations = [[13,4]]
        # if game_state(can_spawn(FACTORY, factory_locations)):
        game_state.attempt_spawn(FACTORY, factory_locations, len(factory_locations))

        scout_spawn_location_options = [[0,13] ,[13, 0] ,[14, 0], [27,13]]
        i = 0
        while (game_state.can_spawn(SCOUT, scout_spawn_location_options[i], 1)):
